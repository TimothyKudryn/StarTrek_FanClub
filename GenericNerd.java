...
public class GenericNerd {
    ...
    private String name;
    private int nerdFactor;
    public String fileName = "nerdRoster.txt";
    ...
    //file for writing into is being initialized.
    //PrintWriter writer = new PrintWriter(fileName);


    public GenericNerd(String name, int nerdFactor) throws FileNotFoundException {
        if(name == null)
        {
    ...
    {
       return new String("Nerd Type: GenericNerd\n" +
               "Name: " + getName() +
    ...
    public void writeNerd(PrintWriter writer)
    {
        writer.println(this.customStringToFile());
    }
